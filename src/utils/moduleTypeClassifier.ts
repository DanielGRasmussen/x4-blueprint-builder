...
const MODULE_DICTIONARY: Record<string, ModuleDefinition> = {
	// ---- Refined Goods ----
	...
	prod_tel_advancedcomposites_macro: {
		displayName: "Teladi Advanced Composite Production",
		type: ModuleType.HighTechGoods
	},
	prod_gen_engineparts_macro: {
		displayName: "Engine Part Production",
		type: ModuleType.HighTechGoods
	},
	prod_tel_engineparts_macro: {
		displayName: "Teladi Engine Part Production",
		type: ModuleType.HighTechGoods
	},
	prod_gen_hullparts_macro: { displayName: "Hull Part Production", type: ModuleType.HighTechGoods },
	prod_tel_hullparts_macro: {
		displayName: "Teladi Hull Part Production",
		type: ModuleType.HighTechGoods
	},
	prod_gen_microchips_macro: {
		displayName: "Microchip Production",
		type: ModuleType.HighTechGoods
	},
	prod_gen_plasmaconductors_macro: {
		displayName: "Plasma Conductor Production",
		type: ModuleType.HighTechGoods
	},
	prod_gen_quantumtubes_macro: {
		displayName: "Quantum Tube Production",
		type: ModuleType.HighTechGoods
	},
	prod_gen_scanningarrays_macro: {
		displayName: "Scanning Array Production",
		type: ModuleType.HighTechGoods
	},
	prod_tel_scanningarrays_macro: {
		displayName: "Teladi Scanning Array Production",
		type: ModuleType.HighTechGoods
	},
	prod_ter_computronicsubstrate_macro: {
		displayName: "Computronic Substrate Production",
		type: ModuleType.HighTechGoods
	},
	prod_ter_metallicmicrolattice_macro: {
		displayName: "Metallic Microlattice Production",
		type: ModuleType.HighTechGoods
	},
	prod_ter_siliconcarbide_macro: {
		displayName: "Silicon Carbide Production",
		type: ModuleType.HighTechGoods
	},
	// ---- Ship Technology ----
	...
	}, // The literal only plural one in game?
	prod_gen_antimatterconverters_macro: {
		displayName: "Antimatter Converter Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_claytronics_macro: {
		displayName: "Claytronics Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_dronecomponents_macro: {
		displayName: "Drone Component Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_fieldcoils_macro: {
		displayName: "Field Coil Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_missilecomponents_macro: {
		displayName: "Missile Component Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_shieldcomponents_macro: {
		displayName: "Shield Component Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_smartchips_macro: {
		displayName: "Smart Chip Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_turretcomponents_macro: {
		displayName: "Turret Component Production",
		type: ModuleType.ShipTechnology
	},
	prod_gen_weaponcomponents_macro: {
		displayName: "Weapon Component Production",
		type: ModuleType.ShipTechnology
	},
	// ---- Recycling ----
	...
	prod_ter_scrap_recycler_macro: {
		displayName: "Terran Scrap Recycler",
	...
	prod_bor_plankton_macro: {
		displayName: "Plankton Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	prod_par_majasnails_macro: {
		displayName: "Maja Snail Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	prod_par_sojabeans_macro: {
		displayName: "Soja Bean Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	prod_spl_cheltmeat_macro: {
		displayName: "Chelt Meat Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	prod_spl_scruffinfruit_macro: {
		displayName: "Scruffin Fruit Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	prod_tel_sunriseflowers_macro: {
		displayName: "Sunrise Flower Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	prod_tel_swampplant_macro: {
		displayName: "Swamp Plant Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	prod_ter_proteinpaste_macro: {
		displayName: "Protein Paste Production",
		type: ModuleType.AgriculturalGoodsL1
	},
	...
	prod_par_sojahusk_macro: {
		displayName: "Soja Husk Production",
		type: ModuleType.AgriculturalGoodsL2
	},
	prod_tel_nostropoil_macro: {
		displayName: "Nostop Oil Production",
		type: ModuleType.AgriculturalGoodsL2
	},
	prod_ter_mre_macro: {
		displayName: "Terran MRE Production",
		type: ModuleType.AgriculturalGoodsL2
	},
	...
	prod_bor_medicalsupplies_macro: {
		displayName: "Boron Medical Supply Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_par_medicalsupplies_macro: {
		displayName: "Paranid Medical Supply Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_spl_medicalsupplies_macro: {
		displayName: "Split Medical Supply Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_tel_medicalsupplies_macro: {
		displayName: "Teladi Medical Supply Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_ter_medicalsupplies_macro: {
		displayName: "Terran Medical Supply Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_arg_spacefuel_macro: {
		displayName: "Spacefuel Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_par_majadust_macro: {
		displayName: "Majadust Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_tel_spaceweed_macro: {
		displayName: "Spaceweed Production",
		type: ModuleType.PharmaceuticalGoods
	},
	prod_ter_stimulants_macro: {
		displayName: "Stimulants Production",
		type: ModuleType.PharmaceuticalGoods
	},
	// ---- Habitation ----
	// ARG
	...
	landmarks_arg_antigonepillar_01_macro: {
		displayName: "Argon L Housing Spire",
		type: ModuleType.Habitation
	},
	landmarks_arg_antigonespire_01_macro: {
		displayName: "Argon XL Housing Spire",
		type: ModuleType.Habitation
	},
	// BOR
	...
	dockarea_arg_m_station_01_lowtech_macro: {
		displayName: "1M6S Basic Dock Area",
		type: ModuleType.DockArea
	},
	dockarea_arg_m_station_01_hightech_macro: {
		displayName: "1M6S Luxury Dock Area",
		type: ModuleType.DockArea
	},
	dockarea_arg_m_station_02_macro: {
		displayName: "3M6S Standard Dock Area",
		type: ModuleType.DockArea
	},
	dockarea_arg_m_station_02_lowtech_macro: {
		displayName: "3M6S Basic Dock Area",
		type: ModuleType.DockArea
	},
	dockarea_arg_m_station_02_hightech_macro: {
		displayName: "3M6S Luxury Dock Area",
		type: ModuleType.DockArea
	},
	dockarea_arg_m_02_tradestation_01_macro: {
		displayName: "8M Luxury Dock Area",
		type: ModuleType.DockArea
	},
	dockarea_bor_m_station_01_standard_macro: {
		displayName: "Boron 4M14S Luxury Dock Area",
		type: ModuleType.DockArea
	},
	dockarea_ter_m_station_01_hightech_macro: {
		displayName: "Terran 4M10S Luxury Dock Area",
		type: ModuleType.DockArea
	},
	// ---- Pier ----
	// ARG
	...
	pier_bor_harbor_04_macro: {
		displayName: "Boron Trading Station 4-Dock Pier",
		type: ModuleType.Pier
	},
	pier_bor_tradestation_01_macro: {
		displayName: "Boron Trading Station Hexa-Dock Pier",
		type: ModuleType.Pier
	},
	// PAR
	...
	pier_ter_tradestation_01_macro: {
		displayName: "Terran Trading Station Hexa-Dock Pier",
		type: ModuleType.Pier
	},
	// ---- Build Module ----
	// GEN
	...
	buildmodule_gen_ships_l_macro: {
		displayName: "L Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_gen_ships_xl_macro: {
		displayName: "XL Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_gen_equip_m_dockarea_01_macro: {
		displayName: "S/M Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_gen_equip_l_macro: {
		displayName: "L Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_gen_equip_xl_macro: {
		displayName: "XL Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	// BOR
	buildmodule_bor_ships_m_dockarea_01_macro: {
		displayName: "Boron S/M Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_bor_ships_l_macro: {
		displayName: "Boron L Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_bor_ships_xl_macro: {
		displayName: "Boron XL Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_bor_equip_m_dockarea_01_macro: {
		displayName: "Boron S/M Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_bor_equip_l_macro: {
		displayName: "Boron L Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_bor_equip_xl_macro: {
		displayName: "Boron XL Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	// TER
	buildmodule_ter_ships_m_dockarea_01_macro: {
		displayName: "Terran S/M Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_ter_ships_l_macro: {
		displayName: "Terran L Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_ter_ships_xl_macro: {
		displayName: "Terran XL Ship Fabrication Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_ter_equip_m_dockarea_01_macro: {
		displayName: "Terran S/M Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_ter_equip_l_macro: {
		displayName: "Terran L Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	buildmodule_ter_equip_xl_macro: {
		displayName: "Terran XL Ship Maintenance Bay",
		type: ModuleType.BuildModule
	},
	// ---- Storage ----
	storage_pir_l_condensate_01_macro: {
		displayName: "Protectyon Shield Generator",
	...
	storage_arg_m_container_01_macro: {
		displayName: "Argon M Container Storage",
		type: ModuleType.Storage
	},
	storage_arg_l_container_01_macro: {
		displayName: "Argon L Container Storage",
		type: ModuleType.Storage
	},
	...
	storage_arg_s_liquid_01_macro: {
		displayName: "Argon S Liquid Storage",
		type: ModuleType.Storage
	},
	storage_arg_m_liquid_01_macro: {
		displayName: "Argon M Liquid Storage",
		type: ModuleType.Storage
	},
	storage_arg_l_liquid_01_macro: {
		displayName: "Argon L Liquid Storage",
		type: ModuleType.Storage
	},
	// BOR
	storage_bor_s_container_01_macro: {
		displayName: "Boron S Container Storage",
		type: ModuleType.Storage
	},
	storage_bor_m_container_01_macro: {
		displayName: "Boron M Container Storage",
		type: ModuleType.Storage
	},
	storage_bor_l_container_01_macro: {
		displayName: "Boron L Container Storage",
		type: ModuleType.Storage
	},
	...
	storage_bor_s_liquid_01_macro: {
		displayName: "Boron S Liquid Storage",
		type: ModuleType.Storage
	},
	storage_bor_m_liquid_01_macro: {
		displayName: "Boron M Liquid Storage",
		type: ModuleType.Storage
	},
	storage_bor_l_liquid_01_macro: {
		displayName: "Boron L Liquid Storage",
		type: ModuleType.Storage
	},
	// PAR
	storage_par_s_container_01_macro: {
		displayName: "Paranid S Container Storage",
		type: ModuleType.Storage
	},
	storage_par_m_container_01_macro: {
		displayName: "Paranid M Container Storage",
		type: ModuleType.Storage
	},
	storage_par_l_container_01_macro: {
		displayName: "Paranid L Container Storage",
		type: ModuleType.Storage
	},
	storage_par_s_solid_01_macro: {
		displayName: "Paranid S Solid Storage",
		type: ModuleType.Storage
	},
	storage_par_m_solid_01_macro: {
		displayName: "Paranid M Solid Storage",
		type: ModuleType.Storage
	},
	storage_par_l_solid_01_macro: {
		displayName: "Paranid L Solid Storage",
		type: ModuleType.Storage
	},
	storage_par_s_liquid_01_macro: {
		displayName: "Paranid S Liquid Storage",
		type: ModuleType.Storage
	},
	storage_par_m_liquid_01_macro: {
		displayName: "Paranid M Liquid Storage",
		type: ModuleType.Storage
	},
	storage_par_l_liquid_01_macro: {
		displayName: "Paranid L Liquid Storage",
		type: ModuleType.Storage
	},
	// SPL
	storage_spl_s_container_01_macro: {
		displayName: "Split S Container Storage",
		type: ModuleType.Storage
	},
	storage_spl_m_container_01_macro: {
		displayName: "Split M Container Storage",
		type: ModuleType.Storage
	},
	storage_spl_l_container_01_macro: {
		displayName: "Split L Container Storage",
		type: ModuleType.Storage
	},
	...
	storage_spl_s_liquid_01_macro: {
		displayName: "Split S Liquid Storage",
		type: ModuleType.Storage
	},
	storage_spl_m_liquid_01_macro: {
		displayName: "Split M Liquid Storage",
		type: ModuleType.Storage
	},
	storage_spl_l_liquid_01_macro: {
		displayName: "Split L Liquid Storage",
		type: ModuleType.Storage
	},
	// TEL
	storage_tel_s_container_01_macro: {
		displayName: "Teladi S Container Storage",
		type: ModuleType.Storage
	},
	storage_tel_m_container_01_macro: {
		displayName: "Teladi M Container Storage",
		type: ModuleType.Storage
	},
	storage_tel_l_container_01_macro: {
		displayName: "Teladi L Container Storage",
		type: ModuleType.Storage
	},
	...
	storage_tel_s_liquid_01_macro: {
		displayName: "Teladi S Liquid Storage",
		type: ModuleType.Storage
	},
	storage_tel_m_liquid_01_macro: {
		displayName: "Teladi M Liquid Storage",
		type: ModuleType.Storage
	},
	storage_tel_l_liquid_01_macro: {
		displayName: "Teladi L Liquid Storage",
		type: ModuleType.Storage
	},
	// TER
	storage_ter_s_container_01_macro: {
		displayName: "Terran S Container Storage",
		type: ModuleType.Storage
	},
	storage_ter_m_container_01_macro: {
		displayName: "Terran M Container Storage",
		type: ModuleType.Storage
	},
	storage_ter_l_container_01_macro: {
		displayName: "Terran L Container Storage",
		type: ModuleType.Storage
	},
	...
	storage_ter_s_liquid_01_macro: {
		displayName: "Terran S Liquid Storage",
		type: ModuleType.Storage
	},
	storage_ter_m_liquid_01_macro: {
		displayName: "Terran M Liquid Storage",
		type: ModuleType.Storage
	},
	storage_ter_l_liquid_01_macro: {
		displayName: "Terran L Liquid Storage",
		type: ModuleType.Storage
	},
	// ---- Defense ----
	// ARG
	...
	defence_arg_disc_01_macro: {
		displayName: "Argon Disc Defense Platform",
		type: ModuleType.Defense
	},
	defence_arg_tube_01_macro: {
		displayName: "Argon Bridge Defense Platform",
		type: ModuleType.Defense
	},
	// BOR
	defence_bor_claim_01_macro: {
		displayName: "Boron Administrative Centre",
		type: ModuleType.Defense
	},
	defence_bor_disc_01_macro: {
		displayName: "Boron Disc Defense Platform",
		type: ModuleType.Defense
	},
	defence_bor_tube_01_macro: {
		displayName: "Boron Bridge Defense Platform",
		type: ModuleType.Defense
	},
	// PAR
	defence_par_claim_01_macro: {
		displayName: "Paranid Administrative Centre",
		type: ModuleType.Defense
	},
	defence_par_disc_01_macro: {
		displayName: "Paranid Disc Defense Platform",
		type: ModuleType.Defense
	},
	defence_par_tube_01_macro: {
		displayName: "Paranid Bridge Defense Platform",
		type: ModuleType.Defense
	},
	// SPL
	defence_spl_claim_01_macro: {
		displayName: "Split Administrative Centre",
		type: ModuleType.Defense
	},
	defence_spl_disc_01_macro: {
		displayName: "Split Disc Defense Platform",
		type: ModuleType.Defense
	},
	defence_spl_tube_01_macro: {
		displayName: "Split Bridge Defense Platform",
		type: ModuleType.Defense
	},
	// TEL
	defence_tel_claim_01_macro: {
		displayName: "Teladi Administrative Centre",
		type: ModuleType.Defense
	},
	defence_tel_disc_01_macro: {
		displayName: "Teladi Disc Defense Platform",
		type: ModuleType.Defense
	},
	defence_tel_tube_01_macro: {
		displayName: "Teladi Bridge Defense Platform",
		type: ModuleType.Defense
	},
	// TER
	defence_ter_claim_01_macro: {
		displayName: "Terran Administrative Centre",
		type: ModuleType.Defense
	},
	defence_ter_disc_01_macro: {
		displayName: "Terran Disc Defense Platform",
		type: ModuleType.Defense
	},
	defence_ter_tube_01_macro: {
		displayName: "Terran Bridge Defense Platform",
		type: ModuleType.Defense
	},
	// ---- Connection ----
	// ARG
	landmarks_arg_antigonearc_01_macro: {
		displayName: "Argon Arc Connection Structure",
	...
	struct_arg_base_02_macro: {
		displayName: "Argon Base Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_arg_base_03_macro: {
		displayName: "Argon Base Connection Structure 03",
		type: ModuleType.Connection
	},
	struct_arg_cross_01_macro: {
		displayName: "Argon Cross Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_arg_vertical_01_macro: {
		displayName: "Argon Vertical Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_arg_vertical_02_macro: {
		displayName: "Argon Vertical Connection Structure 02",
		type: ModuleType.Connection
	},
	landmarks_arg_antigonestraight_01_macro: {
		displayName: "Argon Span Connection Structure 01",
		type: ModuleType.Connection
	},
	landmarks_arg_antigonescaffolding_01_macro: {
		displayName: "Argon Span Connection Structure 02",
		type: ModuleType.Connection
	},
	// BOR
	struct_bor_base_01_macro: {
		displayName: "Boron Base Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_bor_base_02_macro: {
		displayName: "Boron Base Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_bor_base_03_macro: {
		displayName: "Boron Base Connection Structure 03",
		type: ModuleType.Connection
	},
	struct_bor_base_04_macro: {
		displayName: "Boron Base Connection Structure 04",
		type: ModuleType.Connection
	},
	struct_bor_base_05_macro: {
		displayName: "Boron Base Connection Structure 05",
		type: ModuleType.Connection
	},
	struct_bor_cross_01_macro: {
		displayName: "Boron Cross Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_bor_cross_02_macro: {
		displayName: "Boron Cross Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_bor_vertical_01_macro: {
		displayName: "Boron Vertical Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_bor_vertical_02_macro: {
		displayName: "Boron Vertical Connection Structure 02",
		type: ModuleType.Connection
	},
	// PAR
	struct_par_base_01_macro: {
		displayName: "Paranid Base Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_par_base_02_macro: {
		displayName: "Paranid Base Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_par_base_03_macro: {
		displayName: "Paranid Base Connection Structure 03",
		type: ModuleType.Connection
	},
	struct_par_cross_01_macro: {
		displayName: "Paranid Cross Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_par_cross_02_macro: {
		displayName: "Paranid Cross Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_par_cross_03_macro: {
		displayName: "Paranid Cross Connection Structure 03",
		type: ModuleType.Connection
	},
	struct_par_vertical_01_macro: {
		displayName: "Paranid Vertical Connection Structure 01",
		type: ModuleType.Connection
	},
	...
	struct_spl_base_01_macro: {
		displayName: "Split Base Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_spl_base_02_macro: {
		displayName: "Split Base Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_spl_base_03_macro: {
		displayName: "Split Base Connection Structure 03",
		type: ModuleType.Connection
	},
	struct_spl_cross_01_macro: {
		displayName: "Split Cross Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_spl_vertical_01_macro: {
		displayName: "Split Vertical Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_spl_vertical_02_macro: {
		displayName: "Split Vertical Connection Structure 02",
		type: ModuleType.Connection
	},
	// TEL
	struct_tel_base_01_macro: {
		displayName: "Teladi Base Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_tel_base_02_macro: {
		displayName: "Teladi Base Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_tel_base_03_macro: {
		displayName: "Teladi Base Connection Structure 03",
		type: ModuleType.Connection
	},
	struct_tel_cross_01_macro: {
		displayName: "Teladi Cross Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_tel_vertical_01_macro: {
		displayName: "Teladi Vertical Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_tel_vertical_02_macro: {
		displayName: "Teladi Vertical Connection Structure 02",
		type: ModuleType.Connection
	},
	// TER
	struct_ter_base_01_macro: {
		displayName: "Terran Base Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_ter_base_02_macro: {
		displayName: "Terran Base Connection Structure 02",
		type: ModuleType.Connection
	},
	struct_ter_base_03_macro: {
		displayName: "Terran Base Connection Structure 03",
		type: ModuleType.Connection
	},
	struct_ter_cross_01_macro: {
		displayName: "Terran Cross Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_ter_vertical_01_macro: {
		displayName: "Terran Vertical Connection Structure 01",
		type: ModuleType.Connection
	},
	struct_ter_vertical_02_macro: {
		displayName: "Terran Vertical Connection Structure 02",
		type: ModuleType.Connection
	},
	// ---- Other ----
	struct_gen_observationdeck_01_macro: {
		displayName: "Conservatory Observation Deck",
		type: ModuleType.Other
	},
	struct_gen_observationdeck_02_macro: {
		displayName: "Pavilion Observation Deck",
		type: ModuleType.Other
	},
	struct_gen_observationdeck_03_macro: {
		displayName: "Penthouse Observation Deck",
		type: ModuleType.Other
	},
...
export function classifyModule(macro: string): ModuleInfo {
	const definition = MODULE_DICTIONARY[macro];
...
export function getModulesByType(macros: string[]): Record<ModuleType, ModuleInfo[]> {
	...
	macros.forEach(macro => {
		if (!addedMacros.has(macro)) {
			const moduleInfo = classifyModule(macro);
...
export function getAllModules(): Record<ModuleType, ModuleInfo[]> {
	const allMacros = Object.keys(MODULE_DICTIONARY);
	return getModulesByType(allMacros);
}
